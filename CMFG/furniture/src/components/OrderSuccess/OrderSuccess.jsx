            ...
            <div className="h-screen bg-gray-100">
                <div className="p-6 bg-white md:mx-auto">
                    ...
                    <div className="text-center">
                        <h3 className="text-base font-semibold text-center text-gray-900 md:text-2xl">Order Completed!</h3>
                        <p className="my-2 text-gray-600">Thank you for completing your secure online order with us.</p>
